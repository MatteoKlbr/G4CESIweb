<?php
// Vérification de la session active avant d'appeler session_start()
if (session_status() === PHP_SESSION_NONE) {
    session_start();
}

require_once 'config.php';  // Chemin correct vers config.php
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-md-4 text-center">
            <img src="<?php echo !empty($user['avatar']) ? htmlspecialchars($user['avatar']) : 'images/default-avatar.png'; ?>" alt="Avatar" class="img-fluid rounded-circle">
          </div>
          <div class="col-md-8">
